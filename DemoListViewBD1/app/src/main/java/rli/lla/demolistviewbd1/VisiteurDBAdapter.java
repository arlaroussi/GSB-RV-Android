...
public class VisiteurDBAdapter {
    ...
    public VisiteurDBAdapter(Context ctx) {
        this.mCtx = ctx;
    }

    public VisiteurDBAdapter open() throws SQLException {
    ...
    public Cursor fetchAllVisiteurs() {
        ...
        Cursor mCursor = mDb.query(SQLITE_TABLE, new String[] {KEY_ROWID, KEY_CODE,
                        KEY_NOM, KEY_PRENOM, KEY_LOGIN},
                null, null, null, null, null);
